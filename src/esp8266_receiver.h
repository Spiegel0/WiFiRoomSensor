 ...
 * wrap. The identifier stays valid until the function returns.
 */
 ...
 * \param offset The offset inside the received message. It is expected that is
 * always strictly lower than the size of the message.
 */
